...
import "./patches/goofcordPatches";
...
// Tesktop GoofCord-inspired enhancements + innovative tabs
(async () => {
    try {
        const { initDomOptimizer, injectRenderingOptimizations, initInvidiousEmbeds, initMessageEncryption } =
            await import("./patches/goofcordPatches");
        initDomOptimizer();
